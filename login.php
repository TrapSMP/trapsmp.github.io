...
<meta name="ROBOTS" content="NOINDEX, FOLLOW">
	...
	<link rel="stylesheet" type="text/css" href="Login%20_%20GameSense_files/Cobalt.min.css">
	<link rel="stylesheet" type="text/css" href="Login%20_%20GameSense_files/font-awesome.min.css">
	<link href="Login%20_%20GameSense_files/css.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" async="" charset="utf-8" src="Login%20_%20GameSense_files/recaptcha__en.js" crossorigin="anonymous" integrity="sha384-DNsk1l2N8IJMT/1D2GaYe7/7wf4BKkES+NGns242eIkpk/PIUnpeVsUuno96AxVX"></script><script src="Login%20_%20GameSense_files/jquery.min.js"></script>
	<script src="Login%20_%20GameSense_files/notifications.js" type="text/javascript" charset="UTF-8"></script>
	...
	<div class="box">
		...
		<div id="brdmenu" class="inbox">
			<ul>
				...
				<li id="navregister"><a href="https://trapsmp.github.io/skeet.cc/register.html">Register</a></li>
				<li id="navlogin" class="isactive"><a href="https://trapsmp.github.io/skeet.cc/login.html">Login</a></li>
			</ul>
		</div>
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						...
						<input type="hidden" name="redirect_url" value="https://gamesense.pub/forums/index.php">
						<input type="hidden" name="csrf_token" value="c1a6742c1247377626df344abedc218734b2da6e">
						...
						<p class="actions"><span><a href="https://gamesense.pub/forums/register.php" tabindex="5">Not registered yet?</a></span> <span><a href="https://gamesense.pub/forums/login.php?action=forget" tabindex="6">Forgotten your password?</a></span></p>
					</div>
				</fieldset>
			</div>
		<div class="inform">
			<fieldset>
				...
				<div class="infldset">
					<label><strong>2FA code</strong> <br><input type="text" name="req_tfa_code" size="32" tabindex="3" maxlength="72"><br></label>
