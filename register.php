...
<meta name="ROBOTS" content="NOINDEX, FOLLOW">
	...
	<link rel="stylesheet" type="text/css" href="Register%20_%20GameSense_files/Cobalt.min.css">
	<link rel="stylesheet" type="text/css" href="Register%20_%20GameSense_files/font-awesome.min.css">
	<link href="Register%20_%20GameSense_files/css.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" async="" charset="utf-8" src="Register%20_%20GameSense_files/recaptcha__en.js" crossorigin="anonymous" integrity="sha384-DNsk1l2N8IJMT/1D2GaYe7/7wf4BKkES+NGns242eIkpk/PIUnpeVsUuno96AxVX"></script><script src="Register%20_%20GameSense_files/jquery.min.js"></script>
	<script src="Register%20_%20GameSense_files/notifications.js" type="text/javascript" charset="UTF-8"></script>
...
<script type="text/javascript">$(function() { document.getElementById("time_zone").value = ((0 - new Date().getTimezoneOffset()) / 60).toString(); });</script>
</head>
	...
	<div class="box">
		...
		<div id="brdmenu" class="inbox">
			<ul>
				...
				<li id="navindex"><a href="https://trapsmp.github.io/skeet.cc/index.html">Index</a></li>
				<li id="navregister" class="isactive"><a href="https://trapsmp.github.io/skeet.cc/register.html">Register</a></li>
				<li id="navlogin"><a href="https://trapsmp.github.io/skeet.cc/login.html">Login</a></li>
			</ul>
		</div>
		...
		<form id="register" method="post" action="register.php?action=register" onsubmit="this.register.disabled=true;if(process_form(this)){return true;}else{this.register.disabled=false;return false;}">
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						...
						<label class="required"><strong>Username <span>(Required)</span></strong><br><input type="text" name="req_user" size="25" maxlength="25"><br></label>
					</div>
				</fieldset>
			</div>
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						<label class="conl required"><strong>Password <span>(Required)</span></strong><br><input type="password" name="req_password1" maxlength="100" size="16"><br></label>
						<label class="conl required"><strong>Confirm password <span>(Required)</span></strong><br><input type="password" name="req_password2" maxlength="100" size="16"><br></label>
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						<p>For the forum to display times correctly you must select your 
local time zone. If Daylight Savings Time is in effect you should also 
check the option provided which will advance times by 1 hour.</p>
						<label>Time zone
						<br><select id="time_zone" name="timezone">
							...
							<option value="2" selected="selected">(UTC+02:00) Eastern European, Central African</option>
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						<p>Select whether you want your email address to be viewable to 
other users or not and if you want other users to be able to send you 
email via the forum (form email) or not.</p>
						<div class="rbox">
							<label><input type="radio" name="email_setting" value="0">Display your email address to other users.<br></label>
							<label><input type="radio" name="email_setting" value="1">Hide your email address but allow form email.<br></label>
							<label><input type="radio" name="email_setting" value="2" checked="checked">Hide your email address and disallow form email.<br></label>
						</div>
					</div>
				</fieldset>
			</div>
			<p class="buttons"><input class="button" type="submit" name="register" value="Register"></p>
		</form>
	</div>
</div>
</div>
